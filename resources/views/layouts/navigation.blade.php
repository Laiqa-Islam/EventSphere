<nav x-data="{ open: false }" class="bg-gray-800 text-white border-b border-gray-100">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    <x-nav-link :href="route('user.certificates')" :active="request()->routeIs('user.certificates')">
                        {{ __('EventsAttended') }}
                    </x-nav-link>
